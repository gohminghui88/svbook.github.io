		...
		<div class='row'>
			...
			<div class='col-12 col-sm-10'>
				...
				<table id="<?php echo htmlspecialchars($_GET["q"]); ?>" border=1>
					...
					<?php
						generateTable(htmlspecialchars($_GET["q"]), htmlspecialchars($_GET["q"]));
					?>
	...
	<!--<div class="container">-->
		<div class="row">
			<div class="col-12 col-sm-10">
				...
				<div>
					<div id="mycanvas"><?php generateChart(htmlspecialchars($_GET["q"]), "rank", "line"); ?></div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-12 col-sm-10">
				...
				<div>
					<div id="mycanvas2"><?php generateChart(htmlspecialchars($_GET["q"]), "score", "line"); ?></div>
				</div>
			</div>
		</div>
	</div>	
