...
//Ref: https://jadendreamer.wordpress.com/2014/12/24/php-tutorial-looping-through-displaying-a-mysqli-result-set/
	...
	*/
	...
	$inSQL = "INSERT INTO QSOverall (Institution, 2011Rank, 2012Rank, 2013Rank, 2014Rank, 2015Rank, 2016Rank, 2017Rank, 2011Score, 2012Score, 2013Score, 2014Score, 2015Score, 2016Score, 2017Score)
	VALUES (\"" . $uniName . "\",\"" . $rankData["2011Rank"] . "\",\"" . $rankData["2012Rank"] . "\",\"" . $rankData["2013Rank"] . "\",\"" . $rankData["2014Rank"] . "\",\"" . $rankData["2015Rank"] . "\",\"" . $rankData["2016Rank"] . "\",\"" . $rankData["2017Rank"] 
	 . "\",\"" . $scoreData["2011Score"] . "\",\"" . $scoreData["2012Score"] . "\",\"" . $scoreData["2013Score"] . "\",\"" . $scoreData["2014Score"] . "\",\"" . $scoreData["2015Score"] . "\",\"" . $scoreData["2016Score"] . "\",\"" . $scoreData["2017Score"] ."\");";
	
	$inSQL2 = "INSERT INTO QSAcad (Institution, 2011Rank, 2012Rank, 2013Rank, 2014Rank, 2015Rank, 2016Rank, 2017Rank, 2011Score, 2012Score, 2013Score, 2014Score, 2015Score, 2016Score, 2017Score)
	VALUES (\"" . $uniName . "\",\"" . $rankAcadData["2011Rank"] . "\",\"" . $rankAcadData["2012Rank"] . "\",\"" . $rankAcadData["2013Rank"] . "\",\"" . $rankAcadData["2014Rank"] . "\",\"" . $rankAcadData["2015Rank"] . "\",\"" . $rankAcadData["2016Rank"] . "\",\"" . $rankAcadData["2017Rank"] 
	 . "\",\"" . $scoreAcadData["2011Score"] . "\",\"" . $scoreAcadData["2012Score"] . "\",\"" . $scoreAcadData["2013Score"] . "\",\"" . $scoreAcadData["2014Score"] . "\",\"" . $scoreAcadData["2015Score"] . "\",\"" . $scoreAcadData["2016Score"] . "\",\"" . $scoreAcadData["2017Score"] ."\");";
	
	$inSQL3 = "INSERT INTO QSEmp (Institution, 2011Rank, 2012Rank, 2013Rank, 2014Rank, 2015Rank, 2016Rank, 2017Rank, 2011Score, 2012Score, 2013Score, 2014Score, 2015Score, 2016Score, 2017Score)
	VALUES (\"" . $uniName . "\",\"" . $rankEmpData["2011Rank"] . "\",\"" . $rankEmpData["2012Rank"] . "\",\"" . $rankEmpData["2013Rank"] . "\",\"" . $rankEmpData["2014Rank"] . "\",\"" . $rankEmpData["2015Rank"] . "\",\"" . $rankEmpData["2016Rank"] . "\",\"" . $rankEmpData["2017Rank"] 
	 . "\",\"" . $scoreEmpData["2011Score"] . "\",\"" . $scoreEmpData["2012Score"] . "\",\"" . $scoreEmpData["2013Score"] . "\",\"" . $scoreEmpData["2014Score"] . "\",\"" . $scoreEmpData["2015Score"] . "\",\"" . $scoreEmpData["2016Score"] . "\",\"" . $scoreEmpData["2017Score"] ."\");";
	
	$inSQL4 = "INSERT INTO QSFacStud (Institution, 2011Rank, 2012Rank, 2013Rank, 2014Rank, 2015Rank, 2016Rank, 2017Rank, 2011Score, 2012Score, 2013Score, 2014Score, 2015Score, 2016Score, 2017Score)
	VALUES (\"" . $uniName . "\",\"" . $rankFSData["2011Rank"] . "\",\"" . $rankFSData["2012Rank"] . "\",\"" . $rankFSData["2013Rank"] . "\",\"" . $rankFSData["2014Rank"] . "\",\"" . $rankFSData["2015Rank"] . "\",\"" . $rankFSData["2016Rank"] . "\",\"" . $rankFSData["2017Rank"] 
	 . "\",\"" . $scoreFSData["2011Score"] . "\",\"" . $scoreFSData["2012Score"] . "\",\"" . $scoreFSData["2013Score"] . "\",\"" . $scoreFSData["2014Score"] . "\",\"" . $scoreFSData["2015Score"] . "\",\"" . $scoreFSData["2016Score"] . "\",\"" . $scoreFSData["2017Score"] ."\");";
	
	$inSQL5 = "INSERT INTO QSCit (Institution, 2011Rank, 2012Rank, 2013Rank, 2014Rank, 2015Rank, 2016Rank, 2017Rank, 2011Score, 2012Score, 2013Score, 2014Score, 2015Score, 2016Score, 2017Score)
	VALUES (\"" . $uniName . "\",\"" . $rankCitData["2011Rank"] . "\",\"" . $rankCitData["2012Rank"] . "\",\"" . $rankCitData["2013Rank"] . "\",\"" . $rankCitData["2014Rank"] . "\",\"" . $rankCitData["2015Rank"] . "\",\"" . $rankCitData["2016Rank"] . "\",\"" . $rankCitData["2017Rank"] 
	 . "\",\"" . $scoreCitData["2011Score"] . "\",\"" . $scoreCitData["2012Score"] . "\",\"" . $scoreCitData["2013Score"] . "\",\"" . $scoreCitData["2014Score"] . "\",\"" . $scoreCitData["2015Score"] . "\",\"" . $scoreCitData["2016Score"] . "\",\"" . $scoreCitData["2017Score"] ."\");";
	
	$inSQL6 = "INSERT INTO QSIntFac (Institution, 2011Rank, 2012Rank, 2013Rank, 2014Rank, 2015Rank, 2016Rank, 2017Rank, 2011Score, 2012Score, 2013Score, 2014Score, 2015Score, 2016Score, 2017Score)
	VALUES (\"" . $uniName . "\",\"" . $rankIFData["2011Rank"] . "\",\"" . $rankIFData["2012Rank"] . "\",\"" . $rankIFData["2013Rank"] . "\",\"" . $rankIFData["2014Rank"] . "\",\"" . $rankIFData["2015Rank"] . "\",\"" . $rankIFData["2016Rank"] . "\",\"" . $rankIFData["2017Rank"] 
	 . "\",\"" . $scoreIFData["2011Score"] . "\",\"" . $scoreIFData["2012Score"] . "\",\"" . $scoreIFData["2013Score"] . "\",\"" . $scoreIFData["2014Score"] . "\",\"" . $scoreIFData["2015Score"] . "\",\"" . $scoreIFData["2016Score"] . "\",\"" . $scoreIFData["2017Score"] ."\");";
	
	$inSQL7 = "INSERT INTO QSIntStud (Institution, 2011Rank, 2012Rank, 2013Rank, 2014Rank, 2015Rank, 2016Rank, 2017Rank, 2011Score, 2012Score, 2013Score, 2014Score, 2015Score, 2016Score, 2017Score)
	VALUES (\"" . $uniName . "\",\"" . $rankISData["2011Rank"] . "\",\"" . $rankISData["2012Rank"] . "\",\"" . $rankISData["2013Rank"] . "\",\"" . $rankISData["2014Rank"] . "\",\"" . $rankISData["2015Rank"] . "\",\"" . $rankISData["2016Rank"] . "\",\"" . $rankISData["2017Rank"] 
	 . "\",\"" . $scoreISData["2011Score"] . "\",\"" . $scoreISData["2012Score"] . "\",\"" . $scoreISData["2013Score"] . "\",\"" . $scoreISData["2014Score"] . "\",\"" . $scoreISData["2015Score"] . "\",\"" . $scoreISData["2016Score"] . "\",\"" . $scoreISData["2017Score"] ."\");";
