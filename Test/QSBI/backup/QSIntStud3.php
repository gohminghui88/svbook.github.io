...
<h1>QSWUR Dashboard (International Student) </h1>
...
<?php
	...
	echo "<tr><td><b></b></td><td colspan=7><b>International Student Rank</b></td><td colspan=7><b>International Student Score</b></td></tr>";
...
?>	
	<br /><br />
	<h4>International Student (Rank)</h4><br />
	<div class="chart-container">
		<canvas id="mycanvas"></canvas>
	</div>
	
	<br /><br />
	<h4>International Student (Score)</h4><br />
	<div class="chart-container">
	...
	<script>
		...
		$.ajax({
			type: "POST",
			dataType: "json",
			url: "http://www.svbook.com/Test/QSBI/api.php?q=QSIntStud", //Relative or absolute path to response.php file
