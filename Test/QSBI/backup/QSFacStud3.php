...
<h1>QSWUR Dashboard (Faculty Student) </h1>
...
<?php
	...
	echo "<tr><td><b></b></td><td colspan=7><b>Faculty Student Rank</b></td><td colspan=7><b>Faculty Student Score</b></td></tr>";
...
?>	
	<br /><br />
	<h4>Faculty Student (Rank)</h4><br />
	<div class="chart-container">
		<canvas id="mycanvas"></canvas>
	</div>
	
	<br /><br />
	<h4>Faculty Student (Score)</h4><br />
	<div class="chart-container">
	...
	<script>
		...
		$.ajax({
			type: "POST",
			dataType: "json",
			url: "http://www.svbook.com/Test/QSBI/api.php?q=QSFacStud", //Relative or absolute path to response.php file
