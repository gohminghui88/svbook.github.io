...
<h1>QSWUR Dashboard (Academic Reputation) </h1>
...
<?php
	...
	echo "<tr><td><b></b></td><td colspan=7><b>Academic Rank</b></td><td colspan=7><b>Academic Score</b></td></tr>";
...
?>	
	<br /><br />
	<h4>Academic Reputation (Rank)</h4><br />
	<div class="chart-container">
		<canvas id="mycanvas"></canvas>
	</div>
	
	<br /><br />
	<h4>Academic Reputation (Score)</h4><br />
	<div class="chart-container">
	...
	<script>
		...
		$.ajax({
			type: "POST",
			dataType: "json",
			url: "http://www.svbook.com/Test/QSBI/api.php?q=QSAcad", //Relative or absolute path to response.php file
