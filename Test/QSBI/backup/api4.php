<?php
	...
	$res = str_replace("2009Rank", "rank2009", $jsonRes );
	$res = str_replace("2010Rank", "rank2010", $res );
	$res = str_replace("2011Rank", "rank2011", $res );
	...
	$res = str_replace("2009Score", "score2009", $res );
	$res = str_replace("2010Score", "score2010", $res );
