...
<h1>QSWUR Dashboard (International Faculty) </h1>
...
<?php
	...
	echo "<tr><td><b></b></td><td colspan=7><b>International Faculty Rank</b></td><td colspan=7><b>International Faculty Score</b></td></tr>";
...
?>	
	<br /><br />
	<h4>International Faculty (Rank)</h4><br />
	<div class="chart-container">
		<canvas id="mycanvas"></canvas>
	</div>
	
	<br /><br />
	<h4>International Faculty (Score)</h4><br />
	<div class="chart-container">
	...
	<script>
		...
		$.ajax({
			type: "POST",
			dataType: "json",
			url: "http://www.svbook.com/Test/QSBI/api.php?q=QSIntFac", //Relative or absolute path to response.php file
