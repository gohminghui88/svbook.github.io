...
<?php
	...
	function getRankingTable() {
		...
		echo "<table id=\"RankingCompTable\" border=1>";
		echo "<tr><td><b></b></td><td colspan=4><b>Rank</b></td><td colspan=4><b>Score</b></td><td><b></b></td></tr>";
		...
		while ($row = mysqli_fetch_array($data)) {
			...
			echo "<td>" . $row["QSRank"] . "</td>";
			echo "<td>" . $row["THERank"] . "</td>";
			echo "<td>" . $row["ARWURank"] . "</td>";
			echo "<td>" . $row["USNewsRank"] . "</td>";
			
			echo "<td>" . $row["QSScore"] . "</td>";
			echo "<td>" . $row["THEScore"] . "</td>";
			echo "<td>" . $row["ARWUScore"] . "</td>";
			echo "<td>" . $row["USNewsScore"] . "</td>";
