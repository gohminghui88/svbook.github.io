...
<?php
	...
	echo "<tr><td><b></b></td><td colspan=7><b>Citations Rank</b></td><td colspan=7><b>Citations Score</b></td></tr>";
...
?>	
	...
	<script>
		...
		$.ajax({
			type: "POST",
			dataType: "json",
			url: "http://www.svbook.com/Test/QSBI/api.php?q=QSCit", //Relative or absolute path to response.php file
